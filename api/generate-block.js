...
export default async function handler(req, res) {
  ...
  const blocks = {
    1: {
      system: `Premium business consultant. ${formal}NEVER mention specific cities. Return ONLY valid JSON.`,
    ...
    2: {
      system: `Premium business consultant. ${formal}Scripts must be copy-paste ready. NEVER mention specific cities. Return ONLY valid JSON.`,
    ...
    3: {
      system: `Premium business consultant. ${formal}Be very specific and actionable. NEVER mention specific cities. Return ONLY valid JSON.`,
    ...
    4: {
      system: `Premium business consultant. ${formal}Name real tools with URLs. NEVER mention specific cities. Return ONLY valid JSON.`,
      prompt: `${ctx}\n\nReturn JSON for tools, mistakes, scaling:\n{"tools":[{"name":"","url":"","purpose":"","cost":"","how_to_start":"","time_to_setup_minutes":0},{"name":"","url":"","purpose":"","cost":"","how_to_start":"","time_to_setup_minutes":0},{"name":"","url":"","purpose":"","cost":"","how_to_start":"","time_to_setup_minutes":0},{"name":"","url":"","purpose":"","cost":"","how_to_start":"","time_to_setup_minutes":0}],"mistakes":[{"mistake":"","why_fatal":"","how_to_avoid":""},{"mistake":"","why_fatal":"","how_to_avoid":""},{"mistake":"","why_fatal":"","how_to_avoid":""}],"scaling_roadmap":[{"phase":"M1-3","focus":"","revenue_target":"","key_action":"","milestone":""},{"phase":"M4-6","focus":"","revenue_target":"","key_action":"","milestone":""},{"phase":"M7-12","focus":"","revenue_target":"","key_action":"","milestone":""},{"phase":"Rok 2","focus":"","revenue_target":"","key_action":"","milestone":""}],"passive_income":[{"product":"","platform":"","price":"","monthly_potential":"","time_to_create":""},{"product":"","platform":"","price":"","monthly_potential":"","time_to_create":""}]}`,
      tokens: 1500
    }
  };
